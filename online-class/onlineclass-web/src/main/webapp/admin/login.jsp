...
<body>
    <form id="form1" runat="server" action="<%=path %>/login" method="post">
    <div class="Main">
        <ul>
            <li class="top"></li>
            <li class="top2"></li>
            ...
            <li class="topD">
                <ul class="login">
                    ...
                    <li><span class="left login-text">密&nbsp;&nbsp;&nbsp;码:</span> <span style="left">
            ...
            <li class="bottom_B">网站后台管理系统&nbsp;&nbsp;www.Ucaixuexi.com</li>
        </ul>
    </div>
    </form>
</body>
